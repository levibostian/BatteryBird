...
fun MainActivityScreen(
    bluetoothDevices: List<BluetoothDeviceModel>,
    isDemoMode: Boolean,
            ...
            Column(
                ...
                Box(Modifier.weight(1f)) {
                    if (bluetoothDevices.isEmpty()) {
                        ...
                        BluetoothDevicesList(bluetoothDevices = bluetoothDevices, isDemoMode = isDemoMode)
                    }
                }
...
fun ListEmptyView(openBluetoothSettingsOnClick: () -> Unit) {
    Box {
        BluetoothDevicesList(bluetoothDevices = Samples.bluetoothDevices, isDemoMode = true)
...
fun MainActivityScreenEmptyViewPreview() {
    MainActivityScreen(
